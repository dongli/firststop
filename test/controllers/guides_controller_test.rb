...
class GuidesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create guide" do
    assert_difference('Guide.count') do
      post guides_url, params: { guide: { content: @guide.content, title: @guide.title, toc: @guide.toc } }
    end
  ...
  test "should update guide" do
    patch guide_url(@guide), params: { guide: { content: @guide.content, title: @guide.title, toc: @guide.toc } }
