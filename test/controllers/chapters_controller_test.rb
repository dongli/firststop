...
class ChaptersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create chapter" do
    assert_difference('Chapter.count') do
      post chapters_url, params: { chapter: { content: @chapter.content, title: @chapter.title, toc: @chapter.toc } }
    end
  ...
  test "should update chapter" do
    patch chapter_url(@chapter), params: { chapter: { content: @chapter.content, title: @chapter.title, toc: @chapter.toc } }
